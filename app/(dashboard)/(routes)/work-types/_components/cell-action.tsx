...
export const CellAction = ({ data }: { data: WorkTypeColumn }) => {
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/work_types/delete?id=${data?.id}`
      );
  ...
  return (
    <>
      ...
      <EditModal
        ...
        description="you can edit work types."
        entrypoint="work_types"
        data={data}
        isOpen={isEdit}
